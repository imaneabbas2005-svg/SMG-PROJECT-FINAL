...
<div class="form-card">
    ...
    <div class="input-group">
        ...
        <input type="text" name="title" class="input-field" placeholder="Project title" required>
    </div>

    <div class="input-group">
        <i class="fas fa-align-left input-icon"></i>
        <textarea name="description" class="input-textarea" placeholder="Project description"></textarea>
    </div>

    <button type="submit" class="btn-submit">
        <i class="fas fa-save"></i> Submit Project
    </button>
</form>
    <div class="back-link">
