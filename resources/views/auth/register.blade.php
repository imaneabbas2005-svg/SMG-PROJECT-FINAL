...
<head>
  ...
  <title>SMG · Register | Sustainable Management Group</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,300;400;500;600;700;800&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
  <style>
    /* Same CSS as login page – identical design */
    * {
      margin: 0;
      padding: 0;
  ...
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="input-group">
      ...
      <div class="password-wrapper">
        <input type="password" id="password" name="password" class="input-field" placeholder="Password" required style="padding-right: 2.8rem;" autocomplete="new-password">
        <i class="fas fa-eye-slash toggle-pw" data-target="password"></i>
      </div>
    </div>
    ...
    <div class="input-group">
      ...
      <div class="password-wrapper">
        <input type="password" id="password_confirmation" name="password_confirmation" class="input-field" placeholder="Confirm password" required style="padding-right: 2.8rem;" autocomplete="new-password">
        <i class="fas fa-eye-slash toggle-pw" data-target="password_confirmation"></i>
      </div>
    </div>
    ...
    <button type="submit" class="btn-submit">REGISTER <i class="fas fa-user-plus" style="margin-left: 6px;"></i></button>
  </form>
